    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          custom:
          "flex gap-2 border-0 bg-white shadow-sm hover:bg-slate-100 hover:text-slate-900 dark:border-slate-800 dark:bg-neutral-700/40 dark:hover:bg-slate-800 dark:hover:bg-neutral-700/40",
        secondary:
